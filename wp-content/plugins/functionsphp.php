...
/*Полность рабочий шорткод. Грузится из буфера обмена, что ускоряет его  работу.
	    ...
	    <div class="row">
	            ...
	            <div class="site-branding">
	                <div class="brand-card">
	                    <div class="brand-card-body">
	                    	<!-- dipgood.com@gmail.com -->
	                        <p class="brand-card-email"><?php echo esc_html( $atts['email'] ); ?></p>
	                        <!-- +7 (800) 200-69-81 -->
	                        <p class="brand-card-tel1"><?php echo esc_html( $atts['tel1'] ); ?></p>
	                        <p class="brand-card-tel2"><?php echo esc_html( $atts['tel2'] ); ?></p>
	        ...
	        <div class="col toplarge-menu">
	            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	                ...
	                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavBtm2" aria-controls="navbarNavBtm2" aria-expanded="false" aria-label="Toggle navigation">
	                    <span class="navbar-toggler-icon"></span>
	                </button>
	                <div class="collapse navbar-collapse" id="navbarNavBtm2">
	                    <ul class="navbar-nav">
	                        <li class="nav-item active">
	                            <div class="nav-card">
	                                <img class="nav-card-img-top" src="/wp-content/themes/reshaemo/images/i_topmenu1.png" alt="Card image cap">
	                        ...
	                        <li class="nav-item">                                
	                            <div class="nav-card">
	                                <img class="nav-card-img-top" src="/wp-content/themes/reshaemo/images/i_topmenu2.png" alt="Card image cap">
	                                <div class="nav-card-body">
	                        ...
	                        <li class="nav-item">
	                            <div class="nav-card">
	                                <img class="nav-card-img-top" src="/wp-content/themes/reshaemo/images/i_topmenu3.png" alt="Card image cap">
	                                <div class="nav-card-body">
	                        ...
	                        <li class="nav-item">
	                            <div class="nav-card">
	                                <img class="nav-card-img-top" src="/wp-content/themes/reshaemo/images/i_topmenu4.png" alt="Card image cap">
	                                <div class="nav-card-body">
	                        ...
	                        <li class="nav-item">
	                            <div class="nav-card">
	                                <img class="nav-card-img-top" src="/wp-content/themes/reshaemo/images/i_topmenu5.png" alt="Card image cap">
	                                <div class="nav-card-body">
