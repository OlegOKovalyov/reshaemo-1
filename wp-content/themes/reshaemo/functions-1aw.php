...
function reshaemo_scripts() {
	...
	wp_register_style( 'reshaemo_owl_theme_default', get_template_directory_uri() . '/owlcarousel/dist/assets/owl.theme.default.min.css', array(), '20151215', true );
	wp_enqueue_style ( 'reshaemo_owl_theme_default' );*/
...
wp_enqueue_script('common_my');*/
	...
	wp_enqueue_script( 'reshaemo_owl_carousel', get_template_directory_uri() . '/owlcarousel/dist/owl.carousel.min.js', array(), '20151215', true );
