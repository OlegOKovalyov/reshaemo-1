	...
	?>
	    ...
	    <div class="card card-vo">
			<a href="<?php echo bloginfo('template_url'); ?>/images/kdnauk/kandidat-nauk-199718-640x225.jpg"  data-fancybox data-caption="Диплом кандидата наук с 1997 по 2018 год">
				<img class="card-img-top" src="<?php echo bloginfo('template_url'); ?>/images/kdnauk/kandidat-nauk-199718-104x37.jpg" alt="Card image cap" width="104" height="73"></a>
	        <div class="card-body">
	...
	?>
	    ...
	    <div class="card card-vo">
			<a href="<?php echo bloginfo('template_url'); ?>/images/kdnauk/kandidat-nauk-do-1996-640x225.jpg"  data-fancybox data-caption="Диплом кандидата наук до 1996 года">
				<img class="card-img-top" src="<?php echo bloginfo('template_url'); ?>/images/kdnauk/kandidat-nauk-do-1996-104x37.jpg" alt="Card image cap" width="104" height="73"></a>
	        <div class="card-body">
	...
	?>
	    ...
	    <div class="card card-vo">
			<a href="<?php echo bloginfo('template_url'); ?>/images/kdnauk/doctor-nauk-199718-640x226.jpg"  data-fancybox data-caption="Диплом доктора наук с 1997 по 2018 год">
				<img class="card-img-top" src="<?php echo bloginfo('template_url'); ?>/images/kdnauk/doctor-nauk-199718-104x37.jpg" alt="Card image cap" width="104" height="73"></a>
	        <div class="card-body">
	...
	?>
	    ...
	    <div class="card card-vo">
			<a href="<?php echo bloginfo('template_url'); ?>/images/kdnauk/doctor-nauk-do-1996-640x226.jpg"  data-fancybox data-caption="Диплом доктора наук наук до 1996 года">
				<img class="card-img-top" src="<?php echo bloginfo('template_url'); ?>/images/kdnauk/doctor-nauk-do-1996-104x37.jpg" alt="Card image cap" width="104" height="73"></a>
	        <div class="card-body">
