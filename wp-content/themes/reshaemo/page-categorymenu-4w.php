...
<div class="container-fluid page-categorymenu">
    <div class="container">
        ...
        <?php
            ...
            //print_r ( $cur_postid );
            /*if ( is_page( 'vysshee-obrazovanie-menu' ) || '390' == $cur_postid || '579' == $cur_postid || '581' == $cur_postid || '585' == $cur_postid ) {    
                get_sidebar('catmenu-vyshobrz');
            }*/
            ///*if ( is_page( array('vysshee-obrazovanie-menu'/*, 390,579, 581, 585*/) ) ) {    
            //    get_sidebar('catmenu-vyshobrz');
            //}*/            
global $post;     // Если за пределами цикла

if ( is_page(390) || $post->post_parent ) {
    ...
    get_sidebar('catmenu-vyshobrz');
            ...
            elseif ( is_page( 'sredne-specialnoe-obrazovanie-menu' ) || '396' == $post->post_ID ) { 
                get_sidebar('catmenu-srspobrz');

            }
            elseif ( is_page( 'attestaty-shkoly-menu' ) || '401' == $post->post_ID ) { 
                get_sidebar('catmenu-attschool');

            }    
            elseif ( is_page( 'spravki-i-svidetelstva-menu' ) || '404' == $post->post_ID ) { 
                get_sidebar('catmenu-sprsva');
