    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <?php $child_page = array( "56", "74", "196"); ?>
                <h2><?php echo get_the_title($child_page[0]); ?></h2>
                <div class="row">
                    ...
                    <div class="gallery-certs">
                        ...
                        <?php
                        $mypages = get_pages( array( 'child_of' => $child_page[0], 'sort_column' => 'post_date', 'sort_order' => 'desc' ) );
